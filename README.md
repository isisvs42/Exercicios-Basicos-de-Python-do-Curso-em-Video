...
* Aplicar estruturas de controle em problemas práticos
* Trabalhar com estruturas de dados nativas
* Implementar funções e modularização
* Praticar tratamento básico de erros
